...
import com.authmat.application.token.model.PublicKeyMetaDataImp;
...
public class SigningKeyManagerImp implements SigningKeyManager{
    ...
    public synchronized void rotateSigningKey(){
        try {
            ...
            PublicKeyMetaData keyMetaData = new PublicKeyMetaDataImp(encodedPublicKey, keyAlgorithm, jwtAlgorithm);
            this.activeKeyPair = new ActiveKeyPair(keyMetaData, keyPair.getPrivate());
